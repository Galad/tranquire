...
public class ManyUIState<T> : UIState<T>, IQuestion<ImmutableArray<T>>
{
    ...
    private sealed class ManyQuestion<TSource, TConverted> : WebBrowserQuestion<TSource, TConverted, ImmutableArray<TConverted>>
    {
        ...
        /// </summary>
        public override string Name => $"What are the state of the elements identified by {Target} ?";
    }
    ...
    /// </summary>
    /// <returns></returns>
    public override string ToString() => $"What are the state of the elements identified by {Target} ?";
