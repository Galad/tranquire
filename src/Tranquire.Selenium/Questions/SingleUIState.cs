...
namespace Tranquire.Selenium.Questions
{
    ...
    public abstract class SingleUIState<T, TState> : UIState<T> where TState : SingleUIState<T, TState>
    {
        ...
        /// </summary>
        public IQuestion<T, WebBrowser> Value => CreateQuestion<T>(new GenericConverter<T, T>(t => t));
        ...
        public IQuestion<TAnswer, WebBrowser> As<TAnswer>(IConverter<T, TAnswer> converter)
        {
        ...
        private IQuestion<TAnswer, WebBrowser> CreateQuestion<TAnswer>(IConverter<T, TAnswer> converter)
        {
