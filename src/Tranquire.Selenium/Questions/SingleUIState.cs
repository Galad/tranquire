    ...
    where TState : SingleUIState<T, TState>
{
    ...
    private sealed class SingleQuestion<TSource, TConverted> : WebBrowserQuestion<TSource, TConverted, TConverted>
    {
        ...
        /// </summary>
        public override string Name => $"What is the state of the element identified by {Target} ?";
    }
    ...
    /// </summary>
    /// <returns></returns>
    public override string ToString() => $"What is the state of the element identified by {Target} ?";
