...
public class Presence : SingleUIState<bool, Presence>
{
    ...
    private sealed class SafeResolvedTarget : ITarget
    {
    ...
    private sealed class NotFoundElement : IWebElement
    {
        ...
        public ReadOnlyCollection<IWebElement> FindElements(By by) => new(new List<IWebElement>());
