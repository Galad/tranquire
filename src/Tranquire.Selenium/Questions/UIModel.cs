...
public static class UIModel
{
    ...
    private static readonly ConcurrentDictionary<Type, UIModelInfo> _containers = new();
    ...
    private static readonly IntegerConverters _integerConverters = new();
    private static readonly BooleanConverters _booleanConverters = new();
    private static readonly StringConverters _textConverters = new();
    private static readonly DateTimeConverters _dateTimeConverters = new();
    private static readonly DoubleConverters _doubleConverters = new();
    private static readonly StringArrayConverters _stringArrayConverters = new();
    private static readonly IntegerArrayConverters _integerArrayConverters = new();
    private static readonly DoubleArrayConverters _doubleArrayConverters = new();
