namespace Tranquire
{
    ...
    {
        /// <summary>
        /// Execute the given <see cref = "IGivenCommand{T, TResult}"/> when the actor changes the state of the system in order to use it with <see cref = "AttemptsTo(IWhenCommand)"/>
        /// </summary>
        ...
        /// <summary>
        /// Execute the given <see cref = "IGivenCommand{TResult}"/> when the actor changes the state of the system in order to use it with <see cref = "AttemptsTo(IWhenCommand)"/>
        /// </summary>
